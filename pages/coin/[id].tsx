      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Image src={image.large} alt={name} h={["55", null, "130"]} />
            </motion.div>
          ...
          <Table size="sm">
            <Tbody>
              <Tr>
                ...
                <Td isNumeric>
                  <Text fontSize="large">{marketCapRankDisplay}</Text>
                </Td>
              </Tr>
              <Tr>
                <Td>
                ...
                <Td isNumeric>
                  <HStack spacing="0" justifyContent="flex-end">
                    {ctxCurrencyIcon}
                    <Text fontSize="large">{currentPriceDisplay}</Text>
                  </HStack>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td isNumeric>
                  <HStack spacing="0" justifyContent="flex-end">
                    {ctxCurrencyIcon}
                    <Text fontSize="large">{marketCapDisplay}</Text>
                  </HStack>
                </Td>
              </Tr>
            </Tbody>
          ...
          <Line
            data={{
              ...
              datasets: [
                {
                  data: chartDataSet(),
                  label: `Price (Past ${days === 1 ? "24" : days} ${
                    days === 1 ? "Hours" : "Days"
                  }) in ${ctxCurrency.toUpperCase()}`,
                  borderColor: "#EEBC1D",
                  pointRadius: 0,
